...
The *people* table contains elements that describe ...  l

Below is a list of data in the *people* table.l
...
The *skills* table contains elements that describe ...l 

Below is a list of data in the *skills* table.l
...
The *roles* table contains elements that describe ... l
